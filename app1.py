...
def main():
	...
	st.set_page_config(page_title="REJSIK")
	overview = st.container()
	left, right = st.columns(2)
	prediction = st.container()

	st.image("https://f4fcdn.eu/wp-content/uploads/2019/10/Zrzut-ekranu-2019-10-13-o-21.25.10.png")
	...
	with right:
		age_slider = st.slider("Wiek", value=1, min_value=1, max_value=71)
		...
		fare_slider = st.slider("Cena biletu", min_value=0, max_value=94, step=1)
